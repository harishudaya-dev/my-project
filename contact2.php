...
// Set required fields
$required_fields = array('Name','Date','Email','Phone','Course','Address');

// set error messages
$error_messages = array(
	'Name' => 'Please enter a name to proceed.',
	'Date' => 'Please enter a Date to proceed.',
	'Email' => 'Please enter a valid Email Address to continue.',
	'Phone' => 'Please enter a Phone to proceed.',
	'Course' => 'Please enter a Course to proceed.',
	'Address' => 'Please enter a Address to continue.',
);
...
if(!empty($_POST)) {
	...
	if(count($validation) == 0) {
		...
		foreach($_POST as $key => $value) {
			if($key == "Date") {$key = "Date of Birth"; }
			if($key == "Course") {$key = "Course Name"; }
